...
<div class="container mt-5">
    <form action="<?php echo $_SERVER["REQUEST_URI"] ?>" method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="Title" name="Title" maxlength="255" value="<?php $editing
                                                                                                        ? print $editedPage->getTitle()
                                                                                                        : '' ?>">
        </div>
        <div class="mb-3">
            <label for="Content" class="form-label">Content</label>
            <textarea class="form-control" id="Content" name="Content" rows="10"><?php $editing
